module plate_mod
    ...
    type :: plate
        ...
        integer :: Nx, Ny, N_elements, N_nodes, N_eq, N_dof
...
contains
    ...
    subroutine plate_calc_D(this)
        ...
        ! Initialize storage
        allocate(this%A(4:5,4:5), source=0.)
        allocate(this%D(1:6,1:6), source=0.)

        ! Calculate A matrix
        this%A(4,4) = this%G*this%h*5./6.
        this%A(5,5) = this%G*this%h*5./6.

        ! Calculate D matrix
        this%D(1,1) = this%E*this%h**3/(12.*(1-this%v**2))
        this%D(1,2) = this%v*this%E*this%h**3/(12.*(1-this%v**2))
        this%D(2,1) = this%v*this%E*this%h**3/(12.*(1-this%v**2))
        this%D(2,2) = this%E*this%h**3/(12.*(1-this%v**2))
        this%D(6,6) = this%G*this%h**3/12.
    ...
    subroutine plate_assemble_global_stiffness(this,  arg2)
